...
def test_prefers_warehouse_batches_to_shipments():
    in_stock_batch = Batch("in-stock-batch", "BUSY-STREET", 100, eta=None)
    shipment_batch = Batch("shipment-batch", "BUSY-STREET", 100, eta=tomorrow)
    product = Product(sku="BUSY-STREET", batches=[in_stock_batch, shipment_batch])
